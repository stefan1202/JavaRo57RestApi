...
import ro.sda.java57.restapi.exceptions.SpecificSdaException;
import ro.sda.java57.restapi.exceptions.VerySpecificSdaException;

@RestController
@Slf4j
public class ControllerWithLocalExpHandler {

  @GetMapping("/api/resource/generic")
  @ResponseStatus(HttpStatus.NO_CONTENT)
  public void willAlwaysThrowGeneric() {
    throw new SdaException("Sda generic exception");
  }
